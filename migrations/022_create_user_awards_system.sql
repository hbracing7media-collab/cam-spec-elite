...
DROP POLICY IF EXISTS "Allow public read access to award_types" ON public.award_types;
...
DROP POLICY IF EXISTS "Allow public read access to user_awards" ON public.user_awards;
...
DROP POLICY IF EXISTS "Allow authenticated users to view own awards" ON public.user_awards;
...
DROP POLICY IF EXISTS "Allow public read access to forum_post_awards" ON public.forum_post_awards;
...
DROP POLICY IF EXISTS "Allow users to tag awards in own posts" ON public.forum_post_awards;
